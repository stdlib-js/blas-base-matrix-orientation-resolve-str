...
tape( 'the function returns the matrix orientation string associated with a matrix orientation value', function test( t ) {
	var v;
	var i;
...
tape( 'the function returns `null` if unable to resolve a matrix orientation string', function test( t ) {
	var values;
	var i;
